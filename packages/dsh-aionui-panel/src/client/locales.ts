...
const zh = {
  ...
  'explorer.doubleClickOpenWithHint': '用系统「打开方式」对话框打开（Office/WPS/默认程序）',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'explorer.doubleClickOpenWithHint': 'Open with the system "Open With" dialog (Office/WPS/default)',
