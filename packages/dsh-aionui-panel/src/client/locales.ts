...
const zh = {
  ...
  'explorer.menu.openWith': '选择打开方式…',
  'explorer.doubleClickOpenWithHint': '双击：用系统「打开方式」对话框打开（Office/WPS/默认程序）',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'explorer.menu.openWith': 'Choose app to open with…',
  'explorer.doubleClickOpenWithHint': 'Double-click: open with the system "Open With" dialog (Office/WPS/default)',
